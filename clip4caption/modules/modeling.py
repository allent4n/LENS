...
from modules.module_audio import AudioModel, AudioConfig
...
class CaptionGeneratorPreTrainedModel(PreTrainedModel, nn.Module):
    ...
    """
    def __init__(self, bert_config, visual_config, audio_config, decoder_config, *inputs, **kwargs):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_bert_name, visual_model_name, audio_model_name, decoder_model_name,
        ...
        model = cls(bert_config, visual_config, audio_config, decoder_config, *inputs, **kwargs)
...
class CaptionGenerator(CaptionGeneratorPreTrainedModel):
    def __init__(self, bert_config, visual_config, audio_config, decoder_config, task_config):
        super(CaptionGenerator, self).__init__(bert_config, visual_config, audio_config, decoder_config)
        ...
        assert self.audio_frame <= audio_config.max_position_embeddings
