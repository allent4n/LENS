...
def get_parser():
    ...
    parser.add_argument('--seed', type=int, default=2025)#2222
    ...
    parser.add_argument('--task_memsum', action='store_true')
    ...
    parser.add_argument('--audio_num_hidden_layers', type=int, default=2)
    ...
    parser.add_argument('--moment_train_path', type=str, default="scripts/run.sh")
    parser.add_argument('--llms', type=str, default="facebook/bart-large-cnn")
